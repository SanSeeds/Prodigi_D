...
const Payment = () => {
  ...
  useEffect(() => {
    ...
    setFormData((prevData) => ({ ...prevData, price: plan }));
}, [location]);
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    const plan = formData.price; // Assuming formData.price holds the plan name
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="w-full max-w-4xl max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
        ...
        {/* Price Section */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-black mb-2">Plan: <span style={{color: 'green', fontWeight: 'bold'}}> {formData.price} </span> </h3>
        </div>
